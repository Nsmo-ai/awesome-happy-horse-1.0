...
| Entry | What it gives you | Best for |
| --- | --- | --- |
| [Verified Facts](./docs/verified-facts.md) | Clean list of directly supported facts | Fast orientation |
| [Claims Ledger](./docs/claims-ledger.md) | Claim-by-claim status, confidence, and sources | Research and citation |
| [Timeline](./docs/timeline.md) | The sequence of how [Happy Horse](https://tryhappyhorse.com/) became a public topic | Context and chronology |
| [Benchmarks](./docs/benchmarks.md) | Dated leaderboard snapshots with Elo and sample counts | Performance tracking |
| [Official Links and Fakes](./docs/official-links-and-fakes.md) | Canonical surfaced link plus caution around noisy domain claims | Navigation and safety |
| [Happy Horse vs Seedance](./docs/comparisons/happy-horse-vs-seedance.md) | Current public reading of the most important head-to-head comparison | Competitive context |
| [Prompt Library](./docs/prompts/prompt-library.md) | Reusable prompt cases with clear test goals | Hands-on evaluation |
| [Failure Cases](./docs/prompts/failure-cases.md) | Common ways readers and evaluators get misled | Risk reduction |
| [Methodology](./docs/methodology.md) | Status labels, evidence rules, and update logic | Trust and auditability |
